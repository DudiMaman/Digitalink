...
const he = {
  ...
  hero: {
    titlePrefix: 'הופכים נוכחות דיגיטלית',
    rotatingWords: ['לתוצאות.', 'לצמיחה.', 'ללקוחות.', 'להכנסות.'],
    subtitle:
  ...
  contact: {
    eyebrow: 'צרו קשר',
    panelLine: 'בואו נתחיל',
    panelHighlight: 'לצמוח.',
    subtitle: 'ספרו לנו על העסק והיעדים שלכם — ונחזור אליכם עם רעיונות ראשונים תוך יום עסקים.',
    checks: ['בלי התחייבות ובלי אותיות קטנות', 'מענה תוך יום עסקים', 'שיחת היכרות ראשונה — עלינו'],
    interests: [
      'סושיאל מדיה',
      'PPC — מדיה ממומנת',
      'SEO — קידום אורגני',
      'GEO — אופטימיזציה למנועי בינה',
      'Marketing Automation',
      'דאטה ואנליטיקס',
      'פיתוח — אתרים, אפליקציות ומערכות',
      'אחר',
    ],
    form: {
      name: 'שם מלא',
      ...
      successTitle: 'הפרטים נשלחו!',
      successMsg: 'נחזור אליכם תוך יום עסקים.',
...
const en: Content = {
  ...
  hero: {
    titlePrefix: 'We turn digital presence into',
    rotatingWords: ['results.', 'growth.', 'customers.', 'revenue.'],
    subtitle:
  ...
  contact: {
    eyebrow: 'Contact',
    panelLine: "Let's start",
    panelHighlight: 'growing.',
    subtitle: "Tell us about your business and goals — and we'll get back to you with first ideas within one business day.",
    checks: ['No commitment, no fine print', 'Reply within one business day', 'First intro call — on us'],
    interests: [
      'Social Media',
      'PPC — Paid Media',
      'SEO — Organic',
      ...
      'Marketing Automation',
      'Data & Analytics',
      'Development — sites, apps & systems',
      'Other',
    ],
    form: {
      name: 'Full name',
      ...
      successMsg: "We'll get back to you within one business day.",
